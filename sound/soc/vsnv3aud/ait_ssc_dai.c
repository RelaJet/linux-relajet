 ...
 */
static int ait_ssc_startup(struct snd_pcm_substream *substream,
 ...
 */
static void ait_ssc_shutdown(struct snd_pcm_substream *substream,
			       struct snd_soc_dai *dai)
{
	struct atmel_ssc_info *ssc_p = &ssc_info[dai->id];
	struct atmel_pcm_dma_params *dma_params;
...
//		pr_debug("atmel_ssc_shutdown: %s disabled SSC_SR=0x%08x\n",
	...
	pAUD->I2S_MODE_CTL = 0;		//MCLK Disable
 ...
 */
static int ait_ssc_set_dai_fmt(struct snd_soc_dai *cpu_dai,
		unsigned int fmt)
{
 ...
 */
static int ait_ssc_set_dai_clkdiv(struct snd_soc_dai *cpu_dai,
	int div_id, int div)
{
 ...
 * Configure the SSC.
 */
static int ait_ssc_hw_params(struct snd_pcm_substream *substream,
...
static struct snd_soc_dai_ops atmel_ssc_dai_ops = {
	.startup	= ait_ssc_startup,
	.shutdown	= ait_ssc_shutdown,
	.prepare	= ait_ssc_prepare,
	.hw_params	= ait_ssc_hw_params,
	.set_fmt	= ait_ssc_set_dai_fmt,
	.set_clkdiv	= ait_ssc_set_dai_clkdiv,
};

static struct snd_soc_dai_driver ait_ssc_dai[NUM_SSC_DEVICES] = {
	{
		.name = "ait-ssc-dai.0",
		.probe = ait_ssc_probe,
		.remove = ait_ssc_remove,
		.suspend = ait_ssc_suspend,
		.resume = ait_ssc_resume,
		.playback = {
			.channels_min = 2,
			.channels_max = 2,
