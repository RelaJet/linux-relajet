...
static int __init ait8455evb_i2s_wm8973_init(void)
{
	struct clk *pllb;
	int ret;
	pr_debug( "%s\n",__FUNCTION__);
...
static void __exit ait8455evb_i2s_wm8973_exit(void)
{
...
module_init(ait8455evb_i2s_wm8973_init);
module_exit(ait8455evb_i2s_wm8973_exit);
