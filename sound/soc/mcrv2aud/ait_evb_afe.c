...
static int ait8428evb_afe_hw_params(struct snd_pcm_substream *substream,
...
static struct snd_soc_ops ait8428evb_afe_ops = {
	.hw_params = ait8428evb_afe_hw_params,
};
...
static int ait8428_audio_afe_init(struct snd_soc_pcm_runtime *rtd)
{
...
static int __init ait8428evb_afe_init(void)
{
	int ret;
...
static void __exit ait8428evb_afe_exit(void)
{
...
module_init(ait8428evb_afe_init);
module_exit(ait8428evb_afe_exit);
