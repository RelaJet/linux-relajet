...
typedef struct ait_aud_info_ {
	...
	struct ait_pcm_dma_params *dma_params[2];
	//struct ait_aud_state ssc_state;
}ait_afe_info,ait_i2s_info,ait_aud_info;

int ait_afe_set_audio(int /*ssc*/reserve);
int ait_i2s_set_audio(int /*ssc*/reserve);

//for afe to control amplify
