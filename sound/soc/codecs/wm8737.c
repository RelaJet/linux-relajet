...
static const char *micbias_out_enum_text[] = {
	"off",
	"0.75xAVDD",
	"0.9xAVDD",
	"1.2xAVDD",
...
static const struct soc_enum micbias_out_enum =
	SOC_ENUM_SINGLE(WM8737_POWER_MANAGEMENT, 0, 4, micbias_out_enum_text);
...
SOC_ENUM("MICBIAS output ", micbias_out_enum),
