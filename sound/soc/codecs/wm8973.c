	...
	enum snd_soc_bias_level level)
{
	...
	printk("wm8971: wm8971_set_bias_level:%d\n",level);

	switch (level) {
	case SND_SOC_BIAS_ON:
		/* set vmid to 50k and unmute dac */
		snd_soc_write(codec, WM8971_PWR1, pwr_reg | 0x00c0);
		break;
...
#define WM8971_RATES SNDRV_PCM_RATE_8000_96000//(SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_11025 |\
