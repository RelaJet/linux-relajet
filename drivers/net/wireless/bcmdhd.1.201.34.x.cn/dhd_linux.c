...
//	if (!dhd_download_fw_on_driverload) {
#ifdef CONFIG_BCMDHD_AP6330_FW_PATH
		fw = CONFIG_BCMDHD_AP6330_FW_PATH;
#endif /* CONFIG_BCMDHD_FW_PATH */
#ifdef CONFIG_BCMDHD_AP6330_NVRAM_PATH
		nv = CONFIG_BCMDHD_AP6330_NVRAM_PATH;
#endif /* CONFIG_BCMDHD_NVRAM_PATH */
#ifdef CONFIG_BCMDHD_AP6330_CONFIG_PATH
		conf = CONFIG_BCMDHD_AP6330_CONFIG_PATH;
...
dhd_module_init(void)
{
	...
	gpio_reset_pin = AIT_GPIO_WIFI_RESET;

	err = gpio_request_one(gpio_reset_pin,GPIOF_DIR_OUT|GPIOF_INIT_HIGH,"GPIO_WF_RESET");
	if(err)
	{
		DHD_ERROR(("%s: GPIO%d request fail!\n", __FUNCTION__,gpio_reset_pin));
