...
#include <mach/board.h>
//uint gpio_reset_pin = AIT_GPIO_CGPIO6_WIFI_RESET;
uint gpio_reset_pin = AIT_GPIO_WIFI_RESET;
...
DHD_TRACE(("DHD_FLAG_HOSTAP_MODE\n"));		
		...
		if ((!op_mode && strstr(fw_path, "_p2p") != NULL) ||
			...
			dhd_pkt_filter_enable = FALSE;
#endif
DHD_TRACE(("DHD_FLAG_P2P_MODE\n"));		
			dhd->op_mode = DHD_FLAG_P2P_MODE;
		}
		else
DHD_TRACE(("DHD_FLAG_STA_MODE\n"));				
