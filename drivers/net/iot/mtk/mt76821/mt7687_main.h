...
#define DRV_NAME	"MT7687-SPI"
#define ADP_NAME	"MT7687 SPI Ethernet Adapter"
...
typedef struct mt7687_spi_host{
...
//	struct mii_if_info      mii;
	...
	struct work_struct	mt7687_work;
	struct workqueue_struct *mt7687_work_queue;
...
} MT_PRIVATE, *PMT_PRIVATE;

struct mt7687_rxinfo {
	u16	RxPktReady;
	u16	status;
	__le16	len;
	u16 reserved;
