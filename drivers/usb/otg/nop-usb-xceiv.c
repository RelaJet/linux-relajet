...
{
	pr_info("usb_nop_xceiv_register\n");
...
{
	pr_info("usb_nop_xceiv_unregister\n");
...
{
	pr_info("nop_set_suspend\n");

	return 0;
}

static int nop_usb_set_power(struct otg_transceiver *otg, unsigned mA)
{
pr_info("nop_usb_set_power\n");
...
static int __devinit nop_usb_xceiv_probe(struct platform_device *pdev)
{
	...
	nop->otg.set_power	= nop_usb_set_power;
