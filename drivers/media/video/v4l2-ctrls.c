...
const char *v4l2_ctrl_get_name(u32 id)
{
	...
	case V4L2_CID_JPEG_CLASS:		return "Jpeg controls";
	case V4L2_CID_JPEG_CHROMA_SUBSAMPLING:		return "Jpeg Chroma subsampling";
	case V4L2_CID_JPEG_RESTART_INTERVAL:	return "Jpeg Restart interval";
	case V4L2_CID_JPEG_COMPRESSION_QUALITY:		return "Jpeg quality";
	case V4L2_CID_JPEG_ACTIVE_MARKER:	return "Jpeg active marker";

	case V4L2_CID_DETECT_CLASS:		return "MD controls";
	case V4L2_CID_DETECT_MD_MODE:		return "MD mode";
