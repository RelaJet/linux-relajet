...
#if defined(CONFIG_AIT_CHIP_VSN_V3)
    #define CHIP        (VSN_V3)
    #define SYSTEM_CORE_ID	0
#elif defined(CONFIG_AIT_CHIP_MERCURY)
    #define CHIP        (MERCURY)
#elif defined(CONFIG_AIT_CHIP_MCR_V2)
    #define CHIP        (MCR_V2)
    #define SYSTEM_CORE_ID	CHIP_CORE_ID_MCR_V2_SHT
 ...
 */
	...
	#define AIT_DRAM_SIZE       (1024*1024*24)
...
#define AIT_CPUB_ITCM_SIZE          		SZ_4K      // 4K
#define AIT_CPUB_DRAM_PHYS_BASE          0x04000000
