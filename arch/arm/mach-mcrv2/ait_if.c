...
EXPORT_SYMBOL(MMPF_I2cm_ReadBurstData);
EXPORT_SYMBOL(MMPF_I2cm_WriteBurstData);
//EXPORT_SYMBOL(MMPF_I2cm_DMAWriteBurstData);
//EXPORT_SYMBOL(MMPF_I2cm_DMAReadBurstData);
