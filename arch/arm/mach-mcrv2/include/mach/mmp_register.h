...
#define AITC_BASE_PHY_CPU_IPC (0x800069F2) 
#endif
...
#define AITC_BASE_CPU_IPC           ((AITPS_CPU_IPC)    AIT_OPR_P2V(AITC_BASE_PHY_CPU_IPC))
#endif
...
#define AITC_BASE_UART1		((AITPS_US)	AIT_OPR_P2V(AITC_BASE_PHY_UART1)) // US1 Base Address
#define AITC_BASE_UART2		((AITPS_US)	AIT_OPR_P2V(AITC_BASE_PHY_UART2)) // US2 Base Address
#define AITC_BASE_UART3		((AITPS_US)	AIT_OPR_P2V(AITC_BASE_PHY_UART3)) // US3 Base Address
