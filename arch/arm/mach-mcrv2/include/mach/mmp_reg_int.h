...
//-----------------------------------------
// HINT structure (0x8000 9800) for P_V2
// HINT structure (0x8000 6800) for MCR_V2
//-----------------------------------------
...
// INT OPR
#if !defined(BUILD_FW)
#define HINT_CTL            (HINT_BASE +(MMP_ULONG)(&(((AITPS_HINT )0)->HINT_CTL     )))
#define HINT_EN             (HINT_BASE +(MMP_ULONG)(&(((AITPS_HINT )0)->HINT_EN      )))
#define HINT_SR             (HINT_BASE +(MMP_ULONG)(&(((AITPS_HINT )0)->HINT_SR      )))
#endif
