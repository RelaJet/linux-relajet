...
@{ */
    ...
    #define SENSOR_ID_OV4689         0
    #define SENSOR_ID_IMX208         0
	...
	#define	BIND_SENSOR_IMX238		 0
    #define BIND_SENSOR_OV4689       0
    #define BIND_SENSOR_GC0308       0
	#define	BIND_SENSOR_IMX208		 0
	#define	BIND_SENSOR_JXF02		 0
	#define	BIND_SENSOR_ADV748x		 0
    #define BIND_SENSOR_GC0328       0
